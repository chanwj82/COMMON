...
/**
 * {@link mariadbDAO}의 MyBatis 구현체 .
 *
 * Updated on : 2016-07-20 Updated by : IT전략팀, chanwj.
 */
@Qualifier("MariadbDAOMyBatisImpl")
public class MariadbDAOMyBatisImpl implements CommonDAO {

	private static final Logger LOGGER = LoggerFactory.getLogger(MariadbDAOMyBatisImpl.class);
