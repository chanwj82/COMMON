 ...
 */
public class DefinedRadioListRender implements ListRender {

	/**
	 * 생성자.
	 */
	public DefinedRadioListRender() {
	}
	...
	public void doWriteList(HttpServletRequest req, JspWriter jwt, String id, String title, String className, String disabled, ArrayList item, String funcName,
		...
		for (Object o : item) {
			...
			html.append("<input type=\"radio\" id=\"" + id + "\" name=\"" + id + "\" value=\"" + (String) itemMap.get("value") + "\" " + funcName + " "
